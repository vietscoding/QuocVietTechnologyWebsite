    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-section" style="display: inline-block;">
                <ul>
                    <li class="footer-item" style="display: inline;"><a href="about.php">About Us</a></li>
                    <li class="footer-item" style="display: inline;"><a href="contact.php">Contact Us</a></li>
                    <li class="footer-item" style="display: inline;"><a href="terms.php">Terms & Conditions</a></li>
